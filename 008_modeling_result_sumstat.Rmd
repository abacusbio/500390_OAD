...
essential_traits <- c("BodyConditionScore", "Fertility_CR42", 
                      ...
                      "TOP_UdderSupport", "TotalVolume", "TotalFat", "TotalProtein")
```
...
```{r simple_model_coef, fig.show='asis', fig.height=12, fig.width=8}
...
```{r simple_model_coef1, fig.show='asis', fig.height=12, fig.width=8}
...
```{r coef_ebv_gbv_simple, fig.width=8, fig.height=12}
...
```{r coef, fig.width=8, fig.height=12}
# bv <- "EBV"
...
```{r coef_ebv_gbv, fig.width=8, fig.height=12}

df_coef_glms_EBV$evaluation <- "EBV"
df_coef_glms_GBV$evaluation <- "GEBV"
